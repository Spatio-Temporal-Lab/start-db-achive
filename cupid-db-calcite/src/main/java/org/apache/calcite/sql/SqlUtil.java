...
public abstract class SqlUtil {
    ...
    public static SqlOperator lookupRoutine(
        ...
        Iterator<SqlOperator> list = lookupSubjectRoutines(
            opTab,
            typeFactory,
            funcName,
            argTypes,
    ...
    public static Iterator<SqlOperator> lookupSubjectRoutines(
        ...
        Iterator<SqlOperator> routines = lookupSubjectRoutinesByName(
            opTab,
            funcName,
            sqlSyntax,
            category,
        ...
        // the given arguments
        routines = filterRoutinesByTypePrecedence(
            sqlSyntax,
            typeFactory,
            routines,
            argTypes,
    ...
    private static Iterator<SqlOperator> filterRoutinesByParameterTypeAndName(
        ...
        return (Iterator) Iterators.filter(
            ...
            function -> {
                ...
                final SqlOperandMetadata operandMetadata = (SqlOperandMetadata) function
                ...
                for (Pair<RelDataType, RelDataType> p : Pair.zip(paramTypes, permutedArgTypes)) {
                    ...
                    if (argType != null && !SqlTypeUtil.canCastFrom(paramType, argType, coerce)) {
                        return false;
                    }
                }
                return true;
     ...
     */
    private static List<RelDataType> permuteArgTypes(
    ...
    private static Iterator<SqlOperator> filterRoutinesByTypePrecedence(
        ...
        for (final Ord<RelDataType> argType : Ord.zip(argTypes)) {
            ...
            final RelDataType bestMatch = bestMatch(
                typeFactory,
                sqlFunctions,
                argType.i,
                argNames,
    ...
    private static RelDataType bestMatch(
        RelDataTypeFactory typeFactory,
