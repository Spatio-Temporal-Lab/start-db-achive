...
public class StartDBSqlParser extends Parser {
	...
	public static final int
		...
		RULE_createTableStmt = 10, RULE_create_table_definition = 11, RULE_create_table_columns = 12, 
		RULE_create_table_columns_item = 13, RULE_column_name = 14, RULE_create_table_column_inline_cons = 15, 
		RULE_create_table_column_cons = 16, RULE_create_table_fk_action = 17, 
		RULE_create_table_preoptions = 18, RULE_create_table_preoptions_item = 19, 
		RULE_create_table_preoptions_td_item = 20, RULE_create_table_options = 21, 
		RULE_create_table_options_item = 22, RULE_create_table_options_mysql_item = 23, 
		RULE_dtype_default = 24, RULE_showTablesStmt = 25, RULE_dtype_attr = 26, 
		RULE_dtype = 27, RULE_dtypeLen = 28, RULE_createDatabaseStmt = 29, RULE_showDatabasesStmt = 30, 
		RULE_dropDatabaseStmt = 31, RULE_createDatabaseOption = 32, RULE_dropTableStmt = 33, 
		RULE_insertStmt = 34, RULE_insertStmtCols = 35, RULE_insertStmtRows = 36, 
		RULE_insertStmtRow = 37, RULE_truncateStmt = 38, RULE_useStmt = 39, RULE_selectStmt = 40, 
		RULE_cteSelectStmt = 41, RULE_cteSelectStmtItem = 42, RULE_cteSelectCols = 43, 
		RULE_fullselectStmt = 44, RULE_fullselectStmtItem = 45, RULE_fullselectSetClause = 46, 
		RULE_subselectStmt = 47, RULE_selectList = 48, RULE_selectListSet = 49, 
		RULE_selectListLimit = 50, RULE_selectListItem = 51, RULE_selectListAlias = 52, 
		RULE_selectListAsterisk = 53, RULE_intoClause = 54, RULE_fromClause = 55, 
		RULE_fromTableClause = 56, RULE_fromTableNameClause = 57, RULE_fromSubselectClause = 58, 
		RULE_fromJoinClause = 59, RULE_fromJoinTypeClause = 60, RULE_fromTableValuesClause = 61, 
		RULE_fromTableValuesRow = 62, RULE_fromAliasClause = 63, RULE_tableName = 64, 
		RULE_whereClause = 65, RULE_groupByClause = 66, RULE_havingClause = 67, 
		RULE_qualifyClause = 68, RULE_orderByClause = 69, RULE_orderByClauseItem = 70, 
		RULE_sampleClause = 71, RULE_selectOptions = 72, RULE_selectOptionsItem = 73, 
		RULE_updateStmt = 74, RULE_updateAssignment = 75, RULE_updateTable = 76, 
		RULE_updateUpsert = 77, RULE_deleteStmt = 78, RULE_deleteAlias = 79, RULE_describeStmt = 80, 
		RULE_boolExpr = 81, RULE_boolExprAtom = 82, RULE_boolExprUnary = 83, RULE_boolExprSingleIn = 84, 
		RULE_boolExprMultiIn = 85, RULE_boolExprBinary = 86, RULE_boolExprLogicalOperator = 87, 
		RULE_boolExprBinaryOperator = 88, RULE_expr = 89, RULE_exprAtom = 90, 
		RULE_exprInterval = 91, RULE_intervalItem = 92, RULE_exprConcat = 93, 
		...
		RULE_exprFuncParams = 106, RULE_funcParam = 107, RULE_table_name = 108, 
		RULE_qident = 109, RULE_dateLiteral = 110, RULE_timestampLiteral = 111, 
		RULE_ident = 112, RULE_identItem = 113, RULE_string = 114, RULE_intNumber = 115, 
		RULE_decNumber = 116, RULE_boolLiteral = 117, RULE_nullConst = 118, RULE_nonReservedWords = 119;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"showCreateTableStmt", "showStatusStmt", "createTableStmt", "create_table_definition", 
			...
			"create_table_options_item", "create_table_options_mysql_item", "dtype_default", 
			"showTablesStmt", "dtype_attr", "dtype", "dtypeLen", "createDatabaseStmt", 
			"showDatabasesStmt", "dropDatabaseStmt", "createDatabaseOption", "dropTableStmt", 
			"insertStmt", "insertStmtCols", "insertStmtRows", "insertStmtRow", "truncateStmt", 
			...
			"exprFuncParams", "funcParam", "table_name", "qident", "dateLiteral", 
