...
package org.urbcomp.start.db.model.basic.temporal.util
...
object DateTimeUtils {
  implicit def convert2StartDbTimestamp(time: Timestamp): Long = {
    time.getNanos / 1000L
  }

  // we use Int and Long internally to represent [[DateType]] and [[TimestampType]]
  type StartDbDate = Int //unit is day
  type StartDbTimestamp = Long //unit is microseconds
  ...
  def millisToDays(millisUtc: Long): StartDbDate = {
    millisToDays(millisUtc, defaultTimeZone())
  }

  def millisToDays(millisUtc: Long, timeZone: TimeZone): StartDbDate = {
  ...
  def daysToMillis(days: StartDbDate): Long = {
    daysToMillis(days, defaultTimeZone())
  }

  def daysToMillis(days: StartDbDate, timeZone: TimeZone): Long = {
    val millisLocal = days.toLong * MILLIS_PER_DAY
    millisLocal - getOffsetFromLocalMillis(millisLocal, timeZone)
  }

  def dateToString(days: StartDbDate): String =
    getThreadLocalDateFormat.format(toJavaDate(days))

  // Converts Timestamp to string according to Hive TimestampWritable convention.
  def timestampToString(us: StartDbTimestamp): String = {
    timestampToString(us, defaultTimeZone())
  }

  // Converts Timestamp to string according to Hive TimestampWritable convention.
  def timestampToString(us: StartDbTimestamp, timeZone: TimeZone): String = {
  ...
  /**
    ...
    */
  def fromJavaDate(date: Date): StartDbDate = {
  ...
  /**
    ...
    */
  def toJavaDate(daysSinceEpoch: StartDbDate): Date = {
  ...
  /**
    ...
    */
  def toJavaTimestamp(us: StartDbTimestamp): Timestamp = {
  ...
  /**
    ...
    */
  def fromJavaTimestamp(t: Timestamp): StartDbTimestamp = {
    if (t != null) {
  ...
  /**
    ...
    */
  def fromJulianDay(day: Int, nanoseconds: Long): StartDbTimestamp = {
  ...
  /**
    ...
    */
  def toJulianDay(us: StartDbTimestamp): (Int, Long) = {
   ...
   */
  def toMillis(us: StartDbTimestamp): Long = {
   ...
   */
  def fromMillis(millis: Long): StartDbTimestamp = {
    millis * 1000L
  }
  ...
  /**
    ...
    * `T[h]h:[m]m:[s]s.[ms][ms][ms][us][us][us]+[h]h:[m]m`
    */
  def stringToTimestamp(s: String): Option[StartDbTimestamp] = {
    stringToTimestamp(s, defaultTimeZone())
  }

  def stringToTimestamp(s: String, timeZone: TimeZone): Option[StartDbTimestamp] = {
    if (s == null) {
      return None
    }
  ...
  /**
    ...
    * `yyyy-[m]m-[d]dT*`
    */
  def stringToDate(s: String): Option[StartDbDate] = {
    if (s == null) {
      return None
    }
  ...
  /**
    ...
    */
  private def absoluteMicroSecond(microsec: StartDbTimestamp): StartDbTimestamp = {
    microsec + toYearZero * MICROS_PER_DAY
  }

  private def localTimestamp(microsec: StartDbTimestamp): StartDbTimestamp = {
    localTimestamp(microsec, defaultTimeZone())
  }

  private def localTimestamp(microsec: StartDbTimestamp, timeZone: TimeZone): StartDbTimestamp = {
  ...
  /**
    ...
    */
  def getHours(microsec: StartDbTimestamp): Int = {
  ...
  /**
    * Returns the hour value of a given timestamp value. The timestamp is expressed in microseconds.
    */
  def getHours(microsec: StartDbTimestamp, timeZone: TimeZone): Int = {
  ...
  /**
    ...
    * microseconds.
    */
  def getMinutes(microsec: StartDbTimestamp): Int = {
  ...
  /**
    ...
    * microseconds.
    */
  def getMinutes(microsec: StartDbTimestamp, timeZone: TimeZone): Int = {
  ...
  /**
    ...
    * microseconds.
    */
  def getSeconds(microsec: StartDbTimestamp): Int = {
  ...
  /**
    ...
    * microseconds.
    */
  def getSeconds(microsec: StartDbTimestamp, timeZone: TimeZone): Int = {
  ...
  /**
    ...
    */
  private[this] def getYearAndDayInYear(daysSince1970: StartDbDate): (Int, Int) = {
  ...
  /**
    ...
    * since 1.1.1970.
    */
  def getDayInYear(date: StartDbDate): Int = {
  ...
  /**
    ...
    * since 1.1.1970.
    */
  def getYear(date: StartDbDate): Int = {
  ...
  /**
    ...
    * since 1.1.1970.
    */
  def getQuarter(date: StartDbDate): Int = {
  ...
  /**
    ...
    */
  def splitDate(date: StartDbDate): (Int, Int, Int, Int) = {
    var (year, dayInYear) = getYearAndDayInYear(date)
  ...
  /**
    ...
    */
  def getMonth(date: StartDbDate): Int = {
    var (year, dayInYear) = getYearAndDayInYear(date)
    if (isLeapYear(year)) {
      if (dayInYear == 60) {
        return 2
  ...
  /**
    ...
    * since 1.1.1970.
    */
  def getDayOfMonth(date: StartDbDate): Int = {
    var (year, dayInYear) = getYearAndDayInYear(date)
    if (isLeapYear(year)) {
      if (dayInYear == 60) {
        return 29
  ...
  /**
    ...
    */
  private def firstDayOfMonth(absoluteMonth: Int): StartDbDate = {
  ...
  /**
    ...
    */
  private def getDateFromYear(absoluteYear: Int): StartDbDate = {
  ...
  /**
    ...
    */
  def dateAddMonths(days: StartDbDate, months: Int): StartDbDate = {
  ...
  /**
    ...
    * 8 digits.
    */
  def monthsBetween(time1: StartDbTimestamp, time2: StartDbTimestamp): Double = {
  ...
  def getDayOfWeekFromString(string: String): Int = {
    val dowString = string.toUpperCase(Locale.ROOT)
    dowString match {
  ...
  /**
    ...
    */
  def getNextDateForDayOfWeek(startDate: StartDbDate, dayOfWeek: Int): StartDbDate = {
  ...
  /**
    ...
    * since 1.1.1970.
    */
  def getLastDayOfMonth(date: StartDbDate): StartDbDate = {
  ...
  /**
    ...
    */
  def truncDate(d: StartDbDate, level: Int): StartDbDate = {
  ...
  /**
    ...
    */
  def truncTimestamp(t: StartDbTimestamp, level: Int, timeZone: TimeZone): StartDbTimestamp = {
  ...
  def truncTimestamp(d: StartDbTimestamp, level: Int): StartDbTimestamp = {
  ...
  /**
    ...
    * timezone-aware.
    */
  def convertTz(ts: StartDbTimestamp, fromZone: TimeZone, toZone: TimeZone): StartDbTimestamp = {
  ...
  /**
    ...
    */
  def fromUTCTime(time: StartDbTimestamp, timeZone: String): StartDbTimestamp = {
  ...
  /**
    ...
    */
  def toUTCTime(time: StartDbTimestamp, timeZone: String): StartDbTimestamp = {
