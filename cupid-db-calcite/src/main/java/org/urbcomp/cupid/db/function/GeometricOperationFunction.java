...
public class GeometricOperationFunction {
    ...
    @CupidDBFunction("st_area")
    public double st_area(Geometry geom) {
        return geom.getArea();
    }

    @CupidDBFunction("st_centroid")
    public Point st_centroid(Geometry geom) {
        return geom.getCentroid();
    }

    @CupidDBFunction("st_closestPoint")
    ...
    @CupidDBFunction("st_distance")
    public double st_distance(Geometry geom1, Geometry geom2) {
        DistanceOp op = new DistanceOp(geom1, geom2);
        return op.distance();
    }

    @CupidDBFunction("st_distanceSphere")
    ...
    @CupidDBFunction("st_distanceSpheroid")
    ...
    @CupidDBFunction("st_lengthSpheroid")
