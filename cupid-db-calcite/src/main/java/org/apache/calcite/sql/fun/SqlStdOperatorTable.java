...
public class SqlStdOperatorTable extends ReflectiveSqlOperatorTable {
    ...
    public static final SqlSetOperator UNION = new SqlSetOperator(
        "UNION",
        SqlKind.UNION,
        14,
        false
    ...
    public static final SqlSetOperator UNION_ALL = new SqlSetOperator(
        "UNION ALL",
        SqlKind.UNION,
        14,
        true
    ...
    public static final SqlSetOperator EXCEPT = new SqlSetOperator(
        "EXCEPT",
        SqlKind.EXCEPT,
        14,
        false
    ...
    public static final SqlSetOperator EXCEPT_ALL = new SqlSetOperator(
        "EXCEPT ALL",
        SqlKind.EXCEPT,
        14,
        true
    ...
    public static final SqlSetOperator INTERSECT = new SqlSetOperator(
        "INTERSECT",
        SqlKind.INTERSECT,
        18,
        false
    ...
    public static final SqlSetOperator INTERSECT_ALL = new SqlSetOperator(
        "INTERSECT ALL",
        SqlKind.INTERSECT,
        18,
        true
     ...
     */
    public static final SqlMultisetSetOperator MULTISET_UNION = new SqlMultisetSetOperator(
        "MULTISET UNION ALL",
        14,
        true
    );
     ...
     */
    public static final SqlMultisetSetOperator MULTISET_EXCEPT = new SqlMultisetSetOperator(
        "MULTISET EXCEPT ALL",
        14,
        true
    );
     ...
     * or nested within a {@code GROUPING SETS}. */
    public static final SqlInternalOperator ROLLUP = new SqlRollupOperator(
        "ROLLUP",
        SqlKind.ROLLUP
    );
     ...
     * or nested within a {@code GROUPING SETS}. */
    public static final SqlInternalOperator GROUPING_SETS = new SqlRollupOperator(
        "GROUPING SETS",
     ...
     * <code>&lt; ANY</code>).
     */
    public static final SqlQuantifyOperator SOME_LT = new SqlQuantifyOperator(
        SqlKind.SOME,
        SqlKind.LESS_THAN
    );

    public static final SqlQuantifyOperator SOME_LE = new SqlQuantifyOperator(
        SqlKind.SOME,
        SqlKind.LESS_THAN_OR_EQUAL
    );

    public static final SqlQuantifyOperator SOME_GT = new SqlQuantifyOperator(
        SqlKind.SOME,
        SqlKind.GREATER_THAN
    );

    public static final SqlQuantifyOperator SOME_GE = new SqlQuantifyOperator(
        SqlKind.SOME,
        SqlKind.GREATER_THAN_OR_EQUAL
    );

    public static final SqlQuantifyOperator SOME_EQ = new SqlQuantifyOperator(
        SqlKind.SOME,
        SqlKind.EQUALS
    );

    public static final SqlQuantifyOperator SOME_NE = new SqlQuantifyOperator(
        SqlKind.SOME,
        SqlKind.NOT_EQUALS
    );
     ...
     */
    public static final SqlQuantifyOperator ALL_LT = new SqlQuantifyOperator(
        SqlKind.ALL,
        SqlKind.LESS_THAN
    );

    public static final SqlQuantifyOperator ALL_LE = new SqlQuantifyOperator(
        SqlKind.ALL,
        SqlKind.LESS_THAN_OR_EQUAL
    );

    public static final SqlQuantifyOperator ALL_GT = new SqlQuantifyOperator(
        SqlKind.ALL,
        SqlKind.GREATER_THAN
    );

    public static final SqlQuantifyOperator ALL_GE = new SqlQuantifyOperator(
        SqlKind.ALL,
        SqlKind.GREATER_THAN_OR_EQUAL
    );

    public static final SqlQuantifyOperator ALL_EQ = new SqlQuantifyOperator(
        SqlKind.ALL,
        SqlKind.EQUALS
    );

    public static final SqlQuantifyOperator ALL_NE = new SqlQuantifyOperator(
        SqlKind.ALL,
        SqlKind.NOT_EQUALS
    );
     ...
     */
    public static final SqlAggFunction APPROX_COUNT_DISTINCT = new SqlCountAggFunction(
     ...
     */
    public static final SqlAggFunction SOME = new SqlMinMaxAggFunction(
        "SOME",
        SqlKind.MAX,
        OperandTypes.BOOLEAN
    );
     ...
     */
    public static final SqlAggFunction LAST_VALUE = new SqlFirstLastValueAggFunction(
        SqlKind.LAST_VALUE
    );
     ...
     */
    public static final SqlAggFunction FIRST_VALUE = new SqlFirstLastValueAggFunction(
        SqlKind.FIRST_VALUE
    );
     ...
     */
    public static final SqlAggFunction STDDEV = new SqlAvgAggFunction(
        "STDDEV",
        SqlKind.STDDEV_SAMP
    );
     ...
     */
    public static final SqlAggFunction VARIANCE = new SqlAvgAggFunction(
        "VARIANCE",
        SqlKind.VAR_SAMP
    );
     ...
     */
    public static final SqlRankFunction CUME_DIST = new SqlRankFunction(
        SqlKind.CUME_DIST,
     ...
     */
    public static final SqlRankFunction DENSE_RANK = new SqlRankFunction(
        SqlKind.DENSE_RANK,
        ReturnTypes.RANK,
        true
    );
     ...
     */
    public static final SqlRankFunction PERCENT_RANK = new SqlRankFunction(
     ...
     */
    public static final SqlRankFunction RANK = new SqlRankFunction(
        SqlKind.RANK,
        ReturnTypes.RANK,
        true
    );
     ...
     */
    public static final SqlRankFunction ROW_NUMBER = new SqlRankFunction(
        SqlKind.ROW_NUMBER,
        ReturnTypes.RANK,
        false
    );
    ...
    public static final SqlNullTreatmentOperator IGNORE_NULLS = new SqlNullTreatmentOperator(
     ...
     */
    public static final SqlSpecialOperator COLLECTION_TABLE = new SqlCollectionTableOperator(
        "TABLE",
    ...
    public static final SqlOverlapsOperator PERIOD_EQUALS = new SqlOverlapsOperator(
    ...
    public static final SqlSpecialOperator NOT_LIKE = new SqlLikeOperator(
        "NOT LIKE",
        SqlKind.LIKE,
        true
    );
    ...
    public static final SqlSpecialOperator NOT_SIMILAR_TO = new SqlLikeOperator(
        "NOT SIMILAR TO",
        SqlKind.SIMILAR,
        true
    );

    public static final SqlSpecialOperator SIMILAR_TO = new SqlLikeOperator(
        "SIMILAR TO",
        SqlKind.SIMILAR,
        false
    );
     ...
     */
    public static final SqlSpecialOperator ESCAPE = new SqlSpecialOperator(
        "ESCAPE",
        SqlKind.ESCAPE,
        0
    );
     ...
     * true or not.
     */
    public static final SqlSpecialOperator REINTERPRET = new SqlSpecialOperator(
        "Reinterpret",
        SqlKind.REINTERPRET
    ) {
    ...
    public static final SqlMatchFunction LAST = new SqlMatchFunction(
        "LAST",
        SqlKind.LAST,
        ReturnTypes.ARG0_NULLABLE,
        null,
    ...
    public static final SqlMatchFunction PREV = new SqlMatchFunction(
        "PREV",
        SqlKind.PREV,
        ReturnTypes.ARG0_NULLABLE,
        null,
    ...
    public static final SqlFunction NEXT = new SqlFunction(
        "NEXT",
        SqlKind.NEXT,
        ReturnTypes.ARG0_NULLABLE,
        null,
    ...
    public static final SqlMatchFunction CLASSIFIER = new SqlMatchFunction(
        "CLASSIFIER",
        SqlKind.CLASSIFIER,
    ...
    public static final SqlFunction MATCH_NUMBER = new SqlFunction(
        "MATCH_NUMBER ",
        SqlKind.MATCH_NUMBER,
     ...
     */
    public static final SqlFunction CURRENT_CATALOG = new SqlStringContextVariable(
        "CURRENT_CATALOG"
    );
     ...
     */
    public static final SqlFunction LOCALTIME = new SqlAbstractTimeFunction(
        "LOCALTIME",
        SqlTypeName.TIME
    );
     ...
     */
    public static final SqlFunction LOCALTIMESTAMP = new SqlAbstractTimeFunction(
        "LOCALTIMESTAMP",
     ...
     */
    public static final SqlFunction CURRENT_TIME = new SqlAbstractTimeFunction(
        "CURRENT_TIME",
        SqlTypeName.TIME
    );
     ...
     */
    public static final SqlFunction CURRENT_TIMESTAMP = new SqlAbstractTimeFunction(
        "CURRENT_TIMESTAMP",
        SqlTypeName.TIMESTAMP
    );
     ...
     * 3</code>
     */
    public static final SqlDatePartFunction QUARTER = new SqlDatePartFunction(
        "QUARTER",
        TimeUnit.QUARTER
    );
     ...
     * 9</code>
     */
    public static final SqlDatePartFunction MONTH = new SqlDatePartFunction(
        "MONTH",
        TimeUnit.MONTH
    );
     ...
     * 267</code>
     */
    public static final SqlDatePartFunction DAYOFYEAR = new SqlDatePartFunction(
        "DAYOFYEAR",
        TimeUnit.DOY
    );
     ...
     * 23</code>
     */
    public static final SqlDatePartFunction DAYOFMONTH = new SqlDatePartFunction(
        "DAYOFMONTH",
        TimeUnit.DAY
    );
     ...
     * 2</code>
     */
    public static final SqlDatePartFunction DAYOFWEEK = new SqlDatePartFunction(
        "DAYOFWEEK",
        TimeUnit.DOW
    );
     ...
     * 23</code>
     */
    public static final SqlDatePartFunction MINUTE = new SqlDatePartFunction(
        "MINUTE",
        TimeUnit.MINUTE
    );
     ...
     * 45</code>
     */
    public static final SqlDatePartFunction SECOND = new SqlDatePartFunction(
        "SECOND",
        TimeUnit.SECOND
    );
     ...
     * not by name.
     */
    public static final SqlInternalOperator STRUCT_ACCESS = new SqlInternalOperator(
        "$STRUCT_ACCESS",
        SqlKind.OTHER
    );
     ...
     */
    public static final SqlAggFunction COLLECT = new SqlAggFunction(
        "COLLECT",
        null,
        SqlKind.COLLECT,
     ...
     */
    public static final SqlAggFunction LISTAGG = new SqlAggFunction(
        "LISTAGG",
        null,
        SqlKind.LISTAGG,
        ReturnTypes.ARG0_NULLABLE,
     ...
     */
    public static final SqlAggFunction FUSION = new SqlAggFunction(
        "FUSION",
        null,
        SqlKind.FUSION,
        ReturnTypes.ARG0,
     ...
     */
    public static final SqlAggFunction INTERSECTION = new SqlAggFunction(
        "INTERSECTION",
        null,
     ...
     * sequence</code>. */
    public static final SqlOperator CURRENT_VALUE = new SqlSequenceValueOperator(
     ...
     * the {@code TUMBLE} group function. */
    public static final SqlGroupedWindowFunction TUMBLE_START = TUMBLE_OLD.auxiliary(
        SqlKind.TUMBLE_START
    );

    /** The {@code TUMBLE_END} auxiliary function of
     * the {@code TUMBLE} group function. */
    public static final SqlGroupedWindowFunction TUMBLE_END = TUMBLE_OLD.auxiliary(
        SqlKind.TUMBLE_END
    );
     ...
     * the {@code SESSION} group function. */
    public static final SqlGroupedWindowFunction SESSION_START = SESSION_OLD.auxiliary(
        SqlKind.SESSION_START
    );

    /** The {@code SESSION_END} auxiliary function of
     * the {@code SESSION} group function. */
    public static final SqlGroupedWindowFunction SESSION_END = SESSION_OLD.auxiliary(
        SqlKind.SESSION_END
    );
     ...
     * {@code p2}. */
    public static final SqlSpecialOperator PATTERN_PERMUTE = new SqlSpecialOperator(
        "PATTERN_PERMUTE",
        SqlKind.PATTERN_PERMUTE,
        100
    ) {
        @Override
        public void unparse(SqlWriter writer, SqlCall call, int leftPrec, int rightPrec) {
    ...
    public static final SqlSpecialOperator PATTERN_EXCLUDE = new SqlSpecialOperator(
        "PATTERN_EXCLUDE",
    ...
    public static List<Pair<SqlNode, AuxiliaryConverter>> convertGroupToAuxiliaryCalls(
        ...
        if (op instanceof SqlGroupedWindowFunction && op.isGroup()) {
            ImmutableList.Builder<Pair<SqlNode, AuxiliaryConverter>> builder = ImmutableList
                .builder();
    ...
    private static SqlCall copy(SqlCall call, SqlOperator operator) {
        ...
        return new SqlBasicCall(operator, list.toArray(new SqlNode[0]), call.getParserPosition());
    }
