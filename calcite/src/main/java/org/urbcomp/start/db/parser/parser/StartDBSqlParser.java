...
public class StartDBSqlParser extends Parser {
    ...
    public static final int T__0 = 1, T_ACTION = 2, T_ADD2 = 3, T_ALL = 4, T_ALLOCATE = 5, T_ALTER =
        ...
        L_FILE = 399, T_HDFS = 400, T_HIVE = 401;
    ...
    public final WithOptionItemContext withOptionItem() throws RecognitionException {
        ...
        try {
            enterOuterAlt(_localctx, 1);
            {
                ...
                _la = _input.LA(1);
                if (!(((((_la - 391)) & ~0x3f) == 0
                    && ((1L << (_la - 391)) & ((1L << (L_ID - 391)) | (1L << (L_S_STRING - 391))
                        | (1L << (L_D_STRING - 391)))) != 0))) {
    ...
    public static class DtypeContext extends ParserRuleContext {
        ...
        public TerminalNode T_BINARY_INTEGER() {
            return getToken(StartDBSqlParser.T_BINARY_INTEGER, 0);
        }
        ...
        public TerminalNode T_PLS_INTEGER() {
            return getToken(StartDBSqlParser.T_PLS_INTEGER, 0);
        }
        ...
        public TerminalNode T_SIMPLE_INTEGER() {
            return getToken(StartDBSqlParser.T_SIMPLE_INTEGER, 0);
        }
        ...
        public TerminalNode T_TINYINT() {
            return getToken(StartDBSqlParser.T_TINYINT, 0);
        }
