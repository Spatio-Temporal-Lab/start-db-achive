...
public interface CupidDBSqlVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitCreate_table_column_inline_cons(CupidDBSqlParser.Create_table_column_inline_consContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCreate_table_preoptions_td_item(CupidDBSqlParser.Create_table_preoptions_td_itemContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCreate_table_options_mysql_item(CupidDBSqlParser.Create_table_options_mysql_itemContext ctx);
	/**
