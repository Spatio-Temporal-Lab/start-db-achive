...
public class StartDBSqlParser extends Parser {
	...
	public static final int
		...
		T_VARIANCE=364, T_USER=365, T_METADATA=366, T_LONG=367, T_BOOLEAN=368, 
		T_BOOL=369, T_BINARY=370, T_GEOMETRY=371, T_POINT=372, T_LINESTRING=373, 
		T_POLYGON=374, T_MULTIPOINT=375, T_MULTILINESTRING=376, T_MULTIPOLYGON=377, 
		T_GEOMETRYCOLLECTION=378, T_TRAJECTORY=379, T_ROADSEGMENT=380, T_ROADNETWORK=381, 
		T_ADD=382, T_COLON=383, T_COMMA=384, T_PIPE=385, T_DIV=386, T_DOT=387, 
		T_DOT2=388, T_EQUAL=389, T_EQUAL2=390, T_NOTEQUAL=391, T_NOTEQUAL2=392, 
		T_GREATER=393, T_GREATEREQUAL=394, T_LESS=395, T_LESSEQUAL=396, T_MUL=397, 
		T_OPEN_B=398, T_OPEN_P=399, T_OPEN_SB=400, T_CLOSE_B=401, T_CLOSE_P=402, 
		T_CLOSE_SB=403, T_SEMICOLON=404, T_SUB=405, L_ID=406, L_S_STRING=407, 
		L_D_STRING=408, L_INT=409, L_DEC=410, L_WS=411, L_M_COMMENT=412, L_S_COMMENT=413, 
		L_FILE=414, T_HDFS=415, T_HIVE=416;
	public static final int
	...
	public final WithOptionItemContext withOptionItem() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			if ( !(((((_la - 406)) & ~0x3f) == 0 && ((1L << (_la - 406)) & ((1L << (L_ID - 406)) | (1L << (L_S_STRING - 406)) | (1L << (L_D_STRING - 406)))) != 0)) ) {
