...
/**
 * START-DB sql samples used in tests.
 */
public class StartDBSQLSamples {
    ...
    // Use database
    public static final String USE_DATABSE_SAMPLE = "USE DATABASE database_name;";
    ...
    private static String loadSample(String resource) {
        ...
        try {
            InputStream input = StartDBSQLSamples.class.getResourceAsStream(path);
            if (input == null) {
