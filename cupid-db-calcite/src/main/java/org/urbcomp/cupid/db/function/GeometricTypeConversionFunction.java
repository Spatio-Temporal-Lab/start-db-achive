...
public class GeometricTypeConversionFunction {
    ...
    @CupidDBFunction("st_polygonFromGeoJSON")
    ...
    @CupidDBFunction("st_mPointFromGeoJSON")
    ...
    @CupidDBFunction("st_mLineStringFromGeoJSON")
    ...
    @CupidDBFunction("st_mPolygonFromGeoJSON")
    ...
    @CupidDBFunction("st_mPolygonFromWKT")
    ...
    @CupidDBFunction("st_castToPoint")
    ...
    @CupidDBFunction("st_castToLineString")
    ...
    @CupidDBFunction("st_castToPolygon")
    ...
    @CupidDBFunction("st_castToMPoint")
    ...
    @CupidDBFunction("st_castToMLineString")
    ...
    @CupidDBFunction("st_castToMPolygon")
