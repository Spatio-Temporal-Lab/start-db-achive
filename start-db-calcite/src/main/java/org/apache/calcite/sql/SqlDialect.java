...
public class SqlDialect {
    ...
    protected static final Set<SqlOperator> BUILT_IN_OPERATORS_LIST = ImmutableSet.<
        SqlOperator>builder()
    ...
    public SqlDialect(
        ...
        this(
            EMPTY_CONTEXT.withDatabaseProduct(databaseProduct)
    ...
    public SqlDialect(Context context) {
        ...
        this.identifierEndQuoteString = identifierQuoteString == null ? null
            : identifierQuoteString.equals("[") ? "]"
            : identifierQuoteString;
        this.identifierEscapedQuote = identifierQuoteString == null
            ? null
    ...
    public String unquoteStringLiteral(String val) {
        if (val != null
            ...
            final String stripped = val.substring(
                literalQuoteString.length(),
    ...
    @Deprecated // to be removed before 2.0
    public @Nonnull SqlParser.ConfigBuilder configureParser(SqlParser.ConfigBuilder configBuilder) {
        return SqlParser.configBuilder(configureParser(configBuilder.build()));
    }
    ...
    protected Quoting getQuoting() {
        if ("\"".equals(identifierQuoteString) && "\"".equals(identifierEndQuoteString)) {
            return Quoting.DOUBLE_QUOTE;
        } else if ("`".equals(identifierQuoteString) && "`".equals(identifierEndQuoteString)) {
        ...
        DatabaseProduct(
            ...
            dialect = Suppliers.memoize(() -> {
                ...
                return new SqlDialect(
                    SqlDialect.EMPTY_CONTEXT.withDatabaseProduct(DatabaseProduct.this)
                        .withDatabaseProductName(databaseProductName)
    ...
    public interface Context {
        ...
        @Nonnull
        Context withLiteralEscapedQuoteString(String literalEscapedQuoteString);
