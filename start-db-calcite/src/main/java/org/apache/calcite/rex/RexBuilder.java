...
public class RexBuilder {
     ...
     */
    public static final SqlSpecialOperator GET_OPERATOR = new SqlSpecialOperator(
        "_get",
                    ...
                    case INTERVAL_SECOND:
                        ...
                        switch (typeName) {
                            ...
                            case DECIMAL:
                                ...
                                final BigDecimal multiplier = baseUnit(
                                    literal.getTypeName()
                                ).multiplier;
                                final BigDecimal divider = literal.getTypeName()
    ...
    public RexNode makeLiteral(Object value, RelDataType type, boolean allowCast, boolean trim) {
        ...
        switch (sqlTypeName) {
            ...
            case ROW:
                operands = new ArrayList<>();
                // noinspection unchecked
                for (Pair<RelDataTypeField, Object> pair : Pair.zip(
                    type.getFieldList(),
                    (List<Object>) value
                )) {
