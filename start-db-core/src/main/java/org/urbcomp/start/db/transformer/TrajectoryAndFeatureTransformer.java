...
public class TrajectoryAndFeatureTransformer {
     ...
     */
    public Trajectory getTrajectory(SimpleFeature sf, String name) throws JsonProcessingException {
     ...
     */
    public SimpleFeatureType getGeoMeasSFT(SimpleFeatureType sft) {
     ...
     * @throws JsonProcessingException
     */
    public static SimpleFeatureBuilder settMesaSFBuilder(
